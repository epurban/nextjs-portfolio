...
const projects = [
  {
    ...
    logo: { url: "/pick6.png", alt: "Pick6 Logo" },
    images: [{ url: "/picksix1.jpg", alt: "Pick6 Screenshot" }],
    linkText: "Visit Site",
  ...
  },
  {
    ...
    images: [{ url: "/Marketplace2.jpg", alt: "Marketplace Screenshot" }],
  ...
  },
  {
    ...
    logo: { url: "/ninonlinelogo.png", alt: "Nin Online Logo" },
    images: [{ url: "/ninonline.png", alt: "Nin Online Screenshot" }],
    linkText: "Visit Site",
